...
async def main(loop):
    reader, _ = await serial_asyncio.open_serial_connection(url='/Users/jslove/temp/reader', baudrate=115200)
    print('Reader created')
    _, writer = await serial_asyncio.open_serial_connection(url='/Users/jslove/temp/writer', baudrate=115200)
